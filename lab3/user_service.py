...
class UsersService:
    def __init__(self, _connection, neo):
    ...
    def register(self, username):
        ...
        pipeline.execute()
        self.neo.registration(username, user_id)
        return user_id
    ...
    def sign_out(self, user_id) -> int:
        ...
        self.neo.sign_out(user_id)
        return self.connection.srem("online:", login)

    def create_message(self, message_text, sender_id, receiver, tags) -> int or None:
        ...
        pipeline.execute()
        self.neo.create_message(sender_id, receiver_id, {"id": message_id, "tags": tags})
...
user_service = UsersService(connection, neo4j)
